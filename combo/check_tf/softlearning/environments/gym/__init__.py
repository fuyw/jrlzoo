...
MULTIWORLD_ENVIRONMENT_SPECS = (
    {
        'id': 'SawyerDoor-v2',
        'entry_point': 'metaworld.envs.mujoco.sawyer_xyz.v2.sawyer_door_v2:SawyerDoorEnvV2'
    },
    {
        'id': 'SawyerDoorClose-v2',
        'entry_point': 'metaworld.envs.mujoco.sawyer_xyz.v2.sawyer_door_close_v2:SawyerDoorCloseEnvV2'
    },
)
